...
async def join_request(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """
    Automatically approves incoming chat join requests and sends buttons in DM.
    """
    try:  
        ...
        try:
            ...
            logger.warning(f"Could not send DM to user {user.id} (User might not have started the bot yet): {dm_error}")
